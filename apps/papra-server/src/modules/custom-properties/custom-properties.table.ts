...
export const customPropertyDefinitionsTable = sqliteTable(
  ...
  table => [
    uniqueIndex('custom_property_definitions_organization_id_key_unique').on(table.organizationId, table.key),
    index('custom_property_definitions_organization_id_index').on(table.organizationId),
  ],
);
...
export const customPropertySelectOptionsTable = sqliteTable(
  ...
  table => [
    uniqueIndex('custom_property_select_options_definition_id_key_unique').on(table.propertyDefinitionId, table.key),
  ],
);
